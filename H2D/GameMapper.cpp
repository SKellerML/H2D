...
bool GameHandler::saveKeys(tinyxml2::XMLDocument *doc,tinyxml2::XMLElement *bindings)
{
...
bool GameHandler::loadDefaultKeys()
{
	// CLEAR EVERYTHING!!!
	action_keys.clear();
	state_keys.clear();
...
// Actions	
	// Keys
	action_keys.push_back(keyPair(GLFW_KEY_ESCAPE, false));
	action_keys.push_back(keyPair(GLFW_KEY_E, false));
	action_keys.push_back(keyPair(GLFW_KEY_1, false));
	action_keys.push_back(keyPair(GLFW_KEY_2, false));
	action_keys.push_back(keyPair(GLFW_KEY_3, false));
	action_keys.push_back(keyPair(GLFW_KEY_4, false));
	action_keys.push_back(keyPair(GLFW_KEY_5, false));
	action_keys.push_back(keyPair(GLFW_KEY_6, false));
	action_keys.push_back(keyPair(GLFW_KEY_7, false));
	action_keys.push_back(keyPair(GLFW_KEY_8, false));
	action_keys.push_back(keyPair(GLFW_KEY_9, false));
	action_keys.push_back(keyPair(GLFW_KEY_0, false));
...
// States
	...
	state_keys.push_back(keyPair(GLFW_KEY_LEFT_CONTROL, false));
	// Buttons
